...
class Harshvardhan:
    def __init__(self):
        self.role        = "Founder & CEO @ SIN Technologies"
        ...
        self.mission     = "Make India a global leader in AI, EdTech & XR"
...
> *A DPIIT-registered, ISO 9001:2015-certified AI &amp; EdTech startup operating across six verticals.*

| Vertical | What It Does |
|----------|--------------|
| 🎓 **SIN School of AI** | Industry-grade AI education — RAG, GenAI &amp; Agentic AI specializations |
| 🎨 **SIN Brand Studio** | AI-powered brand transformation &amp; content for D2C brands |
| 🥽 **SIN Mixed Reality Studio** | AR/VR/VFX experiences — the *Trilok XR Universe* |
| 📊 **SIN Data Studio** | Data intelligence &amp; analytics solutions |
